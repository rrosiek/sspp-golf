    ...
    <mj-section>
      <mj-column>
        ...
        <mj-text font-size="18px">
          Your golf tournament purchase is complete! Below is your purchase information
          for your records. We'll see you at the course on June 24th!
        </mj-text>

        <mj-table font-size="16px">
          <tr>
            <td style="text-align: right">Golfers Attending:</td>
            <td style="padding: 2px 15px;"><ul>${payload.golfers}</ul></td>
          </tr>
          <tr>
            <td style="text-align: right">Additional Dinner Tickets:</td>
            <td style="padding: 2px 15px;">${payload.dinnerTicketsPurchased}</td>
          </tr>
          <tr>
